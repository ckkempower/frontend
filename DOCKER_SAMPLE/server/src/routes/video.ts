...
async function uploadVideo(
  ...
  return new Promise<string>((resolve, reject) => {
    ...
    let client = new Vimeo(
      "8b90f1e5dfaf207daa52e98e5411108aa666cf5e",
      "7HfaTdP5clUVNJ/LIcGgMe24/orbjvS9JbL671YBG1bpVUn69yFWwGy9ChEOc+JNFDW8+8kCIw0QmjaLCbJnGyoqWqjV1qSibetPEAl92HlFydoFXphgCqETzb2X/+hd",
      "f16c9a312b9acd05c66fe4e07b6abb89"
    );
    client.upload(
      videoPath,
      { name, description },
...
video.post("/addPowerToVideo", requireAuth, async (req, res) => {
  ...
  let video: any = await Video.findOne({
